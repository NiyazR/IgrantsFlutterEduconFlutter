...
import 'ZhalpygrantPage_basy.dart';


import 'package:url_launcher/url_launcher.dart';
import 'package:flutter/widgets.dart';

class ZhalpygrantPage extends StatefulWidget {
  final String dbName;

  const ZhalpygrantPage ({Key key, this.dbName}) : super(key: key);

  @override
  _ZhalpygrantPageState createState() => _ZhalpygrantPageState();
}

class _ZhalpygrantPageState extends State<ZhalpygrantPage > {
  ...
  void initState() {
    ...
    _podcastQuery = _database.reference().child("atauli_grant_list/univers");
