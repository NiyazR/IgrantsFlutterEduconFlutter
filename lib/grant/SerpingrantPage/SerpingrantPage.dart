...
import 'SerpingrantPage_basy.dart';


import 'package:url_launcher/url_launcher.dart';
import 'package:flutter/widgets.dart';

class SerpingrantPage extends StatefulWidget {
  final String dbName;

  const SerpingrantPage ({Key key, this.dbName}) : super(key: key);

  @override
  _SerpingrantPageState createState() => _SerpingrantPageState();
}

class _SerpingrantPageState extends State<SerpingrantPage > {
